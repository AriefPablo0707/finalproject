...
<html>
   <head>
      ...
      <!-- font css -->
      <link href="{{asset('/admin/https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap')}}" rel="stylesheet">
      <!-- Scrollbar Custom CSS -->
      <link rel="stylesheet" href="{{asset('/admin/jquery.mCustomScrollbar.min.css')}}">
      <!-- Tweaks for older IEs-->
      <link rel="stylesheet" href="{{asset('/admin/https://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css')}}">
   </head>
   <body>
